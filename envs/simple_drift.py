...
class DriftingPointMass(gym.Env):
    ...
    def __init__(self, target=0.0, dt=0.1, base_drag=0.35, drift_amplitude=0.75,
                 ...
                 clock_scale=1, max_episode_steps=200):
        super().__init__()
...
def make_point_drift_env(target=0.0, dt=0.1, base_drag=0.35, drift_amplitude=0.75,
                         drift_period=4000, drift_schedule="sin", drift_phase=0.0,
                         action_scale=1.0, position_limit=3.0, velocity_limit=3.0,
    ...
    env = DriftingPointMass(
        target=target, dt=dt, base_drag=base_drag, drift_amplitude=drift_amplitude,
...
def make_point_drift_vector_env(target=0.0, dt=0.1, base_drag=0.35, drift_amplitude=0.75,
                                drift_period=4000, drift_schedule="sin", drift_phase=0.0,
                                action_scale=1.0, position_limit=3.0, velocity_limit=3.0,
